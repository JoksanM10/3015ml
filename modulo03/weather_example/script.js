const API_KEY = "73a008b4b6f9fc1abe691ae3557d695a"; // Reemplaza esto con tu API key
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                data.list.forEach((day) => {
                    forecastHtml += `
                        <strong>Fecha:</strong> ${new Date(day.dt * 1000).toDateString()} 
                        ${new Date(day.dt * 1000).toTimeString()}
                        <br><strong>Temperatura:</strong>${day.main.temp}°F <br>
